    ...
    return (
        <div>
            ...
            <div className="flex justify-between items-center mt-4">
                <button onClick={() => handleAgreement('problem')} disabled={iHaveAgreed} className="bg-lime-500 hover:bg-lime-600 text-gray-900 font-bold py-2 px-4 rounded-lg disabled:bg-gray-600 disabled:cursor-not-allowed transition">
