 ...
 * @param {Problem} problem An object containing all the user-submitted data for the problem.
 ...
 * @param {Problem} problem An object containing the proposed solutions.
